                    ...
                    <div className="flex flex-col h-full">
                        ...
                        <div className="flex-grow p-5">
                                    ...
                                    <div className="flex mb-2">
                                        ...
                                        <div className="mt-1 pr-1">
                                            <a className="inline-flex text-gray-800 hover:text-gray-900" href="#0">
                                                <h2 className="text-xl leading-snug justify-center font-semibold">Admin</h2>
                                            </a>
                                            <div className="flex items-center"><span className="text-sm font-medium text-gray-400 -mt-0.5 mr-1">Admin</span></div>
                                        </div>
                                    </div>
                                </header>
                            </div>
                            ...
                            <div className="mt-2 flex items-center">
                                ...
                                <div className="text-sm ml-1">admin@gmail.com</div>
                            </div>
                        </div>
                        {/* Card footer */}
                    ...
                    <div className="bg-white p-8 rounded-lg shadow-lg">
                        ...
                        <div className='grid grid-cols-3 gap-4'>
                            ...
                            <div className="flex justify-center">
                                ...
                                <button type="button" className="ml-2 px-6 py-2 border border-gray-300 rounded-md hover:bg-gray-100" onClick={closeEditModal}>Cancel</button>
                            </div>
                        </form>
                    </div>
                </div>
